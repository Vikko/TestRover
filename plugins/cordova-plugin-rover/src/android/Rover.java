package org.apache.cordova.rover;
...
public class Rover extends CordovaPlugin {

    // Plugin namespace
    private static final String JS_NAMESPACE = "window.rover";
    ...
    private final ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            RoverService.ForegroundBinder binder = (RoverService.ForegroundBinder) service;

            Rover.this.service = binder.getService();
        }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callback) throws JSONException {
        ...
        if (action.equalsIgnoreCase("stopTracking")) {
            isDisabled = true;
            stopService();
            callback.success();
            return true;
        ...
        if (action.equalsIgnoreCase("startTracking")) {
            isDisabled = false;
            if (inBackground) {
                startService();
            }
    ...
    private void startService() {
        ...
        Intent intent = new Intent(context, RoverService.class);
